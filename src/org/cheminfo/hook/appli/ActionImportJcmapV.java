...
class ActionImportJcampV extends AbstractAction {
	
	AllInformation allInformation;
	
	public ActionImportJcampV(AllInformation allInformation) {
		super("Import vertical jcamp file");
...
//		SpectraData	spectraData = new SpectraData();
		...
		allInformation.getNemo().addJcampVertical(stringUrl);
	}
