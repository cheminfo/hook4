...
class ActionImportPrediction extends AbstractAction {
	...
	public ActionImportPrediction(AllInformation allInformation) {
	...
	private void loadFile (File file)
	{
		...
		allInformation.getNemo().addPrediction(data);
	}
