...
public class DummyApplet extends Applet implements ActionListener, Runnable
{
...
/*		InteractiveSurface dummySurface=new InteractiveSurface();
		dummySurface.setSize((int)(oldWidth), (int)(oldHeight));
		dummySurface.setXML(XMLString);
	
		dummySurface.paintSB(this.getGraphics());
*/
		InteractiveSurface dummySurface=new InteractiveSurface();
		dummySurface.setSize((int)(oldWidth), (int)(oldHeight));
		dummySurface.setXML(XMLString);
		dummySurface.repaint();
		System.out.println("PANEL");
		mainPanel.setXML(XMLString);

//		mainPanel.repaint();
//		mainPanel.paint(this.getGraphics());
