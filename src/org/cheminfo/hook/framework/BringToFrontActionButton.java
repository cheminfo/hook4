...
public class BringToFrontActionButton extends DefaultActionButton
{
	...
	public BringToFrontActionButton(Image inImage, String infoMessage, InteractiveSurface interactions, Class activeClass)
	{
		super(inImage);
